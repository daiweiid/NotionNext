...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '755778c21d0c4d738219bb8327c17495',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '冰心', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的自由职业者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.bingxin.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '冰心, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/daiweiid', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || '冰心', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || '冰心', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'pub-6703576007272182', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '这是冰心的站点', // 站点描述，被notion中的页面描述覆盖
